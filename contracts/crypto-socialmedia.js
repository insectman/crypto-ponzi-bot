...
const contractAddress = '0x2a605B89C3ddf839126DaCCd3FDAF6dF8C18DF76';
...
const getTokenData = async (params) => {
  ...
  const tokenData = await contract.getItem(tokenId);
  const price = tokenData.sellingPrice;
