...
const getTokenIds = async contract => {
  ...
  console.log('getTokenIds', maxCityId, maxCountryId, Array.from({ length: maxCityId }, (x, i) => i)
    .concat(Array.from({ length: maxCountryId - 999 }, (x, i) => i + 1000)));
...
const getTokenDataFnName = 'getToken';
